	...
	function sec:AddSection(Texto,side)
		...
		function inside:AddToggle(Text,Enabled,keybind,Callback)
			...
			local function Update()
				if activated == false then
					...
					TweenService:Create(TextLabel, tweenInfo, { TextColor3 = Color3.fromRGB(197, 197, 197) }):Play()
					spawn(function()
						pcall(function()
							Callback(activated)
						end)
			...
			if keybind then
				...
				game:GetService("UserInputService").InputBegan:connect(function(input, gameProcessed)
					if not gameProcessed and not ischanging then
						local inputKeyCode = input.KeyCode
						if inputKeyCode == KeyCode or (type(KeyCode) == "string" and inputKeyCode.Name == KeyCode) then
							pcall(function()
								Update()
							end)
						end
				...
				KeyButton.MouseButton1Click:connect(function() 
					...
					if v1.KeyCode.Name ~= "Unknown" then
						...
						KeyCode = v1.KeyCode; -- Store the actual KeyCode enum, not just the name
						wait(.2)
						ischanging = false
					end
				end)
			...
			function y:UpdateValue(val)
				activated = val
				-- Update visual state based on new value
				if activated then
					TweenService:Create(color , TweenInfo.new(0.26, Enum.EasingStyle.Quad , Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromRGB(84, 122, 181)}):Play()
					TweenService:Create(TextLabel, tweenInfo, { TextColor3 = Color3.fromRGB(197, 197, 197) }):Play()
				else
			...
			-- Initialize visual state based on Enabled parameter
			if activated then
				TweenService:Create(color , TweenInfo.new(0.26, Enum.EasingStyle.Quad , Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromRGB(84, 122, 181)}):Play()
				TweenService:Create(TextLabel, tweenInfo, { TextColor3 = Color3.fromRGB(197, 197, 197) }):Play()
			else
		...
		function inside:AddButton(Text,Callback)
			...
			Interactive.MouseButton1Click:Connect(function()
				...
				TweenService:Create(TemplateButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {BackgroundColor3 = Color3.fromRGB(84, 122, 181)}):Play()
				TweenService:Create(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()

				wait(0.1)

				TweenService:Create(TemplateButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {BackgroundColor3 = Color3.fromRGB(25, 25, 25)}):Play()
				TweenService:Create(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {TextColor3 = Color3.fromRGB(84, 84, 84)}):Play()
			...
			-- Add hover effects
			Interactive.MouseEnter:Connect(function()
				TweenService:Create(UIStroke, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {Color = Color3.fromRGB(115, 115, 115)}):Play()
				TweenService:Create(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {TextColor3 = Color3.fromRGB(152, 152, 152)}):Play()
			end)

			Interactive.MouseLeave:Connect(function()
				TweenService:Create(UIStroke, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {Color = Color3.fromRGB(52, 52, 52)}):Play()
				TweenService:Create(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {TextColor3 = Color3.fromRGB(84, 84, 84)}):Play()
			end)
			SECTIONHOLDER.Size = UDim2.fromOffset(SECTIONHOLDER.AbsoluteSize.X,  SECTION2UILIB.AbsoluteContentSize.Y + 8) + UDim2.new(0,0,0,23)
			_PARENT.Size = UDim2.new(_PARENT.Size.X.Scale, _PARENT.Size.X.Offset , 0 ,LIST.AbsoluteContentSize.Y + 15);
